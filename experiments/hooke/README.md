...
These archived studies were retained for provenance:

- `pair_stability_v3` — the Hooke pair-stability V3 study and its behavioral baseline.
- `tpen-pair-scan-v1` — the staged screening scan over the Hooke omega=0.5 singlet.
- `tpen-pair-v1` — an allocation-local smoke for the TPEN pair-v1 study.

New work goes through the dispatch seam in `experiments/toolkit/dispatch.py`.
