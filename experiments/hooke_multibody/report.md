...
template enables them. W&B tracking is available through `tracking.wandb.*`
config fields and is disabled by default for smoke and CI runs. To enable it,
include the optional extra, for example
